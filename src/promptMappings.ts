...
export const imagePromptMappings: Record<string, string> = {
  ...
  "hot korean girl gooning": "beautiful korean woman, detailed face, high quality, 8k, professional photography, elegant pose, studio lighting, attractive, realistic skin texture, perfect anatomy, suggestive expression, alluring",
